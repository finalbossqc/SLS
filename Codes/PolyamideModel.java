...
/** Model exported on Mar 27 2025, 23:21 by COMSOL 6.1.0.357. */
public class PolyamideModel {
  ...
  public static Model run() {
    ...
    model.param().set("R", "8.31446261815324 [J/(K*mol)]", "Gas constant");
    ...
    model.component("comp1").material("mat8").propertyGroup("def").func().create("pw1", "Piecewise");
    ...
    model.component("comp1").probe("point4").selection()
         .set(6, 7, 11, 12, 16, 17, 21, 22, 26, 27, 31, 32, 36, 37, 41, 42, 46, 47, 51, 52);
    ...
    model.component("comp1").view("view1").axis().set("xmin", -306.6466064453125);
    model.component("comp1").view("view1").axis().set("xmax", 1506.6468505859375);
    ...
    model.component("comp1").material("mat8").label("Nylon 12");
    ...
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").label("Thermal Conductivity");
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").set("funcname", "k");
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").set("arg", "T");
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").set("smooth", "contd2");
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").set("smoothzone", 0.001);
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1")
         .set("pieces", new String[][]{{"10", "175", "2.88109256e-05*T + 7.67966699e-02"}, {"175", "195", "0.01111547*T - 1.86117649"}, {"195", "400", "1.50697196e-06*T + 3.08569129e-01"}});
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").set("argunit", "degC");
    model.component("comp1").material("mat8").propertyGroup("def").func("pw1").set("fununit", "W/(m*K)");
    model.component("comp1").material("mat8").propertyGroup("def").func("int1").label("Specific Heat");
    model.component("comp1").material("mat8").propertyGroup("def").func("int1").set("funcname", "Cp");
    model.component("comp1").material("mat8").propertyGroup("def").func("int1")
         ...
         {"184.8347596", "20.66805122"}, 
         {"185.860456", "22.67139571"}, 
         {"186.6256825", "23.92933792"}, 
         {"189.039267", "19.83052121"}, 
         {"189.5008689", "17.73435543"}, 
    ...
    model.component("comp1").material("mat8").propertyGroup("def").set("density", "0.8[g/cm^3]");
    model.component("comp1").material("mat8").propertyGroup("def")
    ...
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an1").label("Viscoelastic Parameter 1");
    ...
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an2").label("Viscoelastic Parameter 2");
    ...
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an2")
         .set("plotargs", new String[][]{{"T", "0", "1"}});
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an3").label("Viscoelastic Relaxation");
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an3").set("funcname", "aT");
    ...
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an4").label("Viscoelastic Parameter 3");
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an4").set("funcname", "C");
    model.component("comp1").material("mat8").propertyGroup("rheo").func("an4").set("expr", "0.18");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg4").feature("surf1").set("expr", "mu + eta");
    ...
    model.study("std1").feature("opt").set("ubound", new String[]{"2000 [mm/s]"});
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg4").set("looplevel", new int[]{202});
